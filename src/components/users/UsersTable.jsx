	...
	return (
		<section className="rounded-(--d-20) bg-white px-(--d-30) py-(--d-24) shadow">
			<div className="mb-(--d-30) flex items-start justify-between gap-(--d-20)">
				...
				<button type="button" onClick={ clearFilters } className="flex cursor-pointer items-center gap-1.5 rounded-(--d-8) border border-[#C3D3E2] bg-white duration-200 hover:bg-[#c3d3e2aa] px-(--d-16) py-(--d-10) text14px-desktop font-medium text-text leadng-[1.4]">
					Clear Filters
				</button>
			</div>
